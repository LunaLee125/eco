...
String msg = "o"; //used for bluetooth commands
...
void motorControl(){
  ...
  if(MyBlue.available() > 0);
    ...
    // find which motor is being moved (LT for left thruster, RT fro right thruster
    // CT for conveyor belt tilt, CB for conveyor belt)
  ...
  if(type.equals("LT")){
    ...
    Serial.println("move conveyor belt tilt");
    ...
    Serial.println("move conveyor belt");
    Serial.println("ok");
